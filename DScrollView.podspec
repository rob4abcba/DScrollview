...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rob4abcba/DScrollView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rob4abcba' => 'rob_abcba@yahoo.com' }
  s.source           = { :git => 'https://github.com/rob4abcba/DScrollView.git', :tag => s.version.to_s }
